...
{:else if report}
  <div class="report">
    ...
    <div class="report__actions no-print fade-in" style="animation-delay: 0.3s">
      <button type="button" class="btn btn-glass report__print" onclick={() => window.print()}>
