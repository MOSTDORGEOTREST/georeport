  ...
  useEffect(() => {
    ...
    function imageMove() {
      ...
      if (IsMobile() && homeImgLink) {
        homeImgLink.addEventListener("click", () => {
  ...
  return (
    <>
      <div className="index_contener">
        <div className="index_content" id="home">
          <p>
        ...
        <div className="home-img" id="homeImg">
          <img className="home-img__image" src={mainimg} alt="mainimg" />
              ...
              <div className="figure__path">
                <div className="figure__path_wrapper">
                  <span
                    ...
                    style={{
                      backgroundColor: "var(--brown_logo)",
                      outlineColor: "var(--brown_logo)",
                    }}
                  ></span>
              ...
              <div className="figure__path">
                <div className="figure__path_wrapper">
                  <span
                    className="figure__pathStart"
                    style={{
                      backgroundColor: "var(--beige_logo)",
                      outlineColor: "var(--beige_logo)",
                    }}
                  ></span>
                  <div className="figure__path_rest">
                    <span className="figure__pathPoint"></span>
              ...
              <div className="figure__path">
                <div className="figure__path_wrapper">
                  <span
                    className="figure__pathStart"
                    style={{
                      backgroundColor: "var(--green_logo)",
                      outlineColor: "var(--green_logo)",
                    }}
                  ></span>
                  <div className="figure__path_rest">
                    <span className="figure__pathPoint"></span>
        ...
        <div className="index_content" id="license">
          ...
          <p>Подключайте свою лабораторию к нам!</p>
          <p>
          ...
          <p>Вы можете бесплатно протестировать сервис:</p>
